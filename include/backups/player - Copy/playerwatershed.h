...
enum WatershedPlayerAnim {IONA_SWIM_IDLE = ANIM_LAND + 1, IONA_SWIM, IONA_SWIM_TWIRL, IONA_FIN_JUMP, IONA_FIN_FALL, IONA_LAND_FINS,
                          ...
                          IONA_SHOOT_GROUND, IONA_SHOOT_JUMP, IONA_SHOOT_BACK_JUMP,
                          IONA_SHOOT_DOWN, IONA_SHOOT_UP,
                          ...
                          IONA_SHOOT_SWIM_JUMP, IONA_SHOOT_SWIM_JUMP_BACK,
                          IONA_SHOOT_RECOILA, IONA_SHOOT_RECOILB,
                          IONA_SWIM_BRAKE, IONA_SWIM_BRAKE_RECOV, IONA_DSHOOT_BRAKE, IONA_USHOOT_BRAKE,
                          IONA_RUN_BRAKE, IONA_IDLE_BRAKE, IONA_SHOOT_BRAKE,
