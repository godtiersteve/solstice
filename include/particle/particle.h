...
enum ParticleBlendType {BLEND_NORMAL, BLEND_ADD, BLEND_SUBTRACT, BLEND_MULITPLY, BLEND_DIVIDE};
...
public:
    ...
    bool mVerticallyOriented;
    float mDampingX, mDampingY, mDampingZ;
    ...
    virtual void Update(float t = 1.0f);
    ...
    virtual void SetAngle(float a)                              {mAngle = a;}
